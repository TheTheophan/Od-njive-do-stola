...
--SELECT * from 
select * from poljoprivredniks
select * from slikas
select * from tip_paketas
--select * from TipPaketaBiljke
select * from biljka_poljoprivrednikas
select * from biljkas
select * from paket_biljakas
select * from grads
select * from paket_korisnikas
...
--poljoprivredniks Inserti
INSERT INTO poljoprivredniks (adresa, ime, prezime, gradID, brojTelefona, brojHektara, brojGazdinstva, plastenickaProizvodnja)
...
--users inserti
INSERT INTO users (adresaDostave, uputstvoZaDostavu, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
	VALUES('JurijaGagarina113', 'Prvi sprat (zgrada ima visoko prizemlje)', 'mteofanovic4622IT@raf.rs','Marko Teofanovic',  'Pa55w.rd', '0638389960', '11070', 1, 1, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Bulevar Zorana Dindica 101, Beograd', 'milenko1992@gmail.com','Nikola Jovanovic', 'G7pZ#h1F', '060 123 4567', '11000', 1, 1, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Ulica Patrijarha Pavla 3, Beograd', 'sanja.tadic22@yahoo.com','Maja Markovic', '9gAqTz3!V', '064 234 5678', '11010', 1, 1, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Novi Beograd 45, Beograd', 'nikola.jovanovic87@hotmail.com','Luka Petrovic', 'JmL2$dXp', '063 345 6789', '11020', 1, 1, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Vojvode Vlahovica 7, Beograd', 'ivana.krstic10@outlook.com','Jovana Simic', 'Q6x#BuX0', '061 456 7890', '11030', 1, 1, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Ruzveltova 88, Beograd', 'boba.simic56@gmail.com','Stefan Milosevic', '7zWk@R2d', '062 567 8901', '11040', 1, 5, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Banjica 15, Beograd', 'dusan1987@yahoo.com','Ana Stankovic', 'D0sVn@z1', '063 678 9012', '11050', 1, 6, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Kraljice Marije 32, Beograd', 'marko.milosevic74@aol.com','Vladimir Kovacevic', 'H!aS3tX7', '064 789 0123', '11060', 1, 7, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Slavija 55, Beograd', 'zoran.petrovic3@gmail.com','Ivana Krstic', 'T5sX$K1j', '065 890 1234', '11070', 1, 7, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Ustanicka 62, Beograd', 'b9stojanovic@gmail.com','Marko Popovic', '6vR9sF@b', '066 901 2345', '11080', 1, 7, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Makenzijeva 17, Beograd', 'anastasija.markovic99@icloud.com','Tijana Djordjevic', 'mL8yB$g1', '067 012 3456', '11090', 1, 10, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Jermenska 23, Beograd', 'petar.maksimovic12@yahoo.com','Nemanja Milutinovic', 'C3tJ@fA7', '068 123 4567', '11101', 1, 11, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Svetog Save 8, Beograd', 's0lukic@live.com','Dragana Vasic', 'yU9qZl&2', '069 234 5678', '11111', 1, 12, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Mihajla Pupina 29, Beograd', 'goran.rebic25@gmail.com','Petar Mladenovic', 'N5mF$R8p', '060 345 6789', '11130', 1, 12, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Vladimira Popovica 14, Beograd', 'ana.petrova80@hotmail.com','Marija Pavlovic', 'd7Y!vB1W', '064 456 7890', '11140', 1, 12, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Pera Todorovica 6, Beograd', 'david.milutinovic33@gmail.com','Aleksandar Kostic', 'G2qPvT#b', '063 567 8901', '11150', 1, 15, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Vracar 22, Beograd', 'vladimir.kovacevic7@outlook.com','Ivana Nikolic', 'Jz8h0U3c', '061 678 9012', '11160', 1, 16, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Dzordza Vasingtona 11, Beograd', 'nina.stankovic21@gmail.com','Bogdan Savic', 'kL5rP7#o', '062 789 0123', '11170', 1, 17, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Dr. Ivana Ribara 9, Beograd', 's1ilic@aol.com','Dunja Jankovic', '9iQd@4Z', '063 890 1234', '11180', 1, 17, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Alekse Nenadovica 13, Beograd', 'ivo.jovanovic28@yahoo.com','Andrej Lukic', 'X2cY$8jF', '064 901 2345', '11190', 1, 17, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Jatihova 25, Beograd', 'marta.popovic18@icloud.com','Sofija Tomic', '5RzB1yN@', '065 012 3456', '11200', 1, 17, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Futoski put 20, Novi Sad', 'ljiljana.kostic52@gmail.com','Milan Jelic', 'W7gQ2eL!F', '066 123 4567', '21000', 3, 21, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Kopacki put 4, Novi Sad', 'stevan.marinkovic65@aol.com','Milica Pavlovic', 'rU9v@y5X', '067 234 5678', '21010', 3, 22, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Gajdobra 2, Novi Sad', 'dragana.djordjevic77@gmail.com','Maksim Radovic', 'K8zZl$3d', '060 456 7890', '21020', 3, 23, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Jovanova 6, Novi Sad', 'nemanja.knezevic44@live.com','Vera Todorovic', 'P3sQ1&7V', '064 567 8901', '21030', 3, 24, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Futoski put 10, Novi Sad', 'jovana.ivanovic36@outlook.com','Dusan Radosavljevic', 'Yj6nF9p#D', '063 678 9012', '21040', 3, 25, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Pivarska 12, Novi Sad', 'vuk.dragovic19@gmail.com','Katarina Vukovic', 'L5Vb@3sT', '061 789 0123', '21050', 3, 26, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Franje Kuhaca 5, Novi Sad', 's5krstic@aol.com','Bojan Savic', 'fK2dQ$z1', '062 890 1234', '21060', 3, 27, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Laze Kostica 8, Novi Sad', 'milo.mihajlovic8@yahoo.com','Lana Stojanovic', '9Jp@zX6A', '063 901 2345', '21070', 3, 28, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Maksima Gorkog 16, Novi Sad', 'vesna.djukic22@gmail.com','Filip Markovic', 'T4aNmY1$', '064 012 3456', '21080', 3, 29, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Sutjeska 3, Novi Sad', 'natalija.simic40@icloud.com','Tamara Djuric', 'cR7@wqP3', '065 123 4567', '21090', 3, 30, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Brace Jugovic 3, Kragujevac', 'nenad.radovic55@gmail.com','Vuk Kovacevic', 'B1vT5i@F', '066 234 5678', '34000', 2, 31, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Svetog Save 12, Kragujevac', 'viktor.lazic17@outlook.com','Nikolina Mitrovic', 'W8Y!j9dR', '067 345 6789', '34010', 2, 32, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Gornji Milanovac 10, Kragujevac', 'dragoslav.kolaric90@yahoo.com','Jelena Mihajlovic', 'zD3qf#A6', '060 567 8901', '34020', 2, 33, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Dimitrija Tucovica 5, Kragujevac', 'tanja.petrovic32@aol.com','Stefan Kolaric', 'H5xT@p1L', '064 678 9012', '34030', 2, 34, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Zoranova 6, Kragujevac', 'b3stankovic@gmail.com','Teodora Simic', 'yV8oD7q#', '063 789 0123', '34040', 2, 35, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Nikole Pasica 14, Nis', 's1vic@icloud.com','Goran Milinkovic', 'U2cZ1s9K', '061 890 1234', '18000', 4, 36, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Bulevar 12, Nis', 'jovan.djuric44@hotmail.com','Milan Rajkovic', 'L3mYt7b@', '062 901 2345', '18010', 4, 37, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Miroslava Antica 9, Nis', 'slobodan.markovic5@gmail.com','Slavica Jovic', 'R1pXzF6@', '063 012 3456', '18020', 4, 38, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Vojvode Stepe 5, Nis', 'katarina.mihajlovic23@live.com','Luka Zivkovic', '4Nikolic', '064 123 4567', '18030', 4, 39, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Jovanova 13, Nis', 'zdravko.djordjevic60@aol.com','Ivana Sreckovic', 'M6qVb3zP', '065 234 5678', '18040', 4, 40, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Pionirska 11', 'ivan.vojvodic91@gmail.com','Jovan Vasiljevic', 'B1dT5Y$Q', '066 345 6789', '24000', 7, NULL, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Knez Mihailova 8', 'tijana.bjelica71@yahoo.com','Nina Krstic', 'F3jZ9p@R', '067 456 7890', '23000', 12, NULL, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Ulica Marka Kraljevica 5', 'nevena.kovacevic19@outlook.com','Mateja Vasic', 'D8v@7Zk1', '060 678 9012', '26000', 18, NULL, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Svetog Ilije 13', 'b4nikolic@gmail.com','Bojana Djukic', 'nX2q0pJ#', '062 234 5678', '32000', 26, NULL, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Trg Cara Lazara 8', 'milos.joksimovic82@icloud.com','Sara Jovanovic', 'R4y@S6hP', '064 345 6789', '36000', 33, NULL, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Pavla Vujisica 17', 'dusica.simonovic16@outlook.com','Vasilije Lazic', 'tZ9Yq#G2', '061 567 8901', '11300', 35, NULL, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Vladimira Nazora 3', 'z0mich@aol.com','Nina Pavlic', 'F7dP1zB0', '062 678 9012', '16000', 42, NULL, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Nikole Tesle 9', 'boris.anic51@gmail.com','Danilo Markovic', '3AqV#R4d', '063 789 1234', '31000', 46, 48, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Milosa Obilica 7', 'sasa.kovacevic30@live.com','Ivana Bozic', 'L9jY@5pV', '065 901 2345', '14000', 49, 49, 0 );
INSERT INTO users (adresaDostave, email, name, password, brojTelefona, postanskiBroj,gradID, poljoprivrednikID, is_admin  )
    VALUES('Jovanova 18', 'milica.djuric53@hotmail.com','Sanja Petrovic', 'm4rkoP#7', '060 234 5678', '15000', 50, 50, 0 );


--slikas Inserti
INSERT INTO slikas(upotrebaSlike, nazivDatoteke,  poljoprivrednikID)
...
--biljkas inserti
INSERT INTO biljkas (opisBiljke, nazivBiljke, sezona)
...
INSERT INTO biljka_poljoprivrednikas(biljkaID, poljoprivrednikID, minNedeljniPrinos, stanjeBiljke)
...
--tip_paketas inserti
INSERT INTO tip_paketas(cenaGodisnjePretplate, cenaMesecnePretplate, opisPaketa, nazivPaketa, cenaRezervacije)
	VALUES(399, 49, 'Od njive do stola paket: Za Mene
...
INSERT INTO tip_paketas(cenaGodisnjePretplate, cenaMesecnePretplate, opisPaketa, nazivPaketa, cenaRezervacije)
	VALUES(499, 59, 'Od njive do stola paket paket
Za Nas
...
INSERT INTO tip_paketas(cenaGodisnjePretplate, cenaMesecnePretplate, opisPaketa, nazivPaketa, cenaRezervacije)
	VALUES(649, 74, 'Od njive do stola paket paket
Moja Basta
...
--paket_korisnikas inserti
INSERT INTO paket_korisnikas(godisnjaPretplata, tipPaketaID, userID)
    VALUES(0, 2, 1);
INSERT INTO paket_korisnikas(godisnjaPretplata, tipPaketaID, userID)
    VALUES(0, 2, 2);
INSERT INTO paket_korisnikas(godisnjaPretplata, tipPaketaID, userID)
...
--paket_biljakas inserti
INSERT INTO paket_biljakas(paketKorisnikaID, biljkaPoljoprivrednikaID, kilaza)
    VALUES(1, 1, 6.12);
INSERT INTO paket_biljakas(paketKorisnikaID, biljkaPoljoprivrednikaID, kilaza)
    VALUES(1, 2, 7.34);
INSERT INTO paket_biljakas(paketKorisnikaID, biljkaPoljoprivrednikaID, kilaza)
...
--fakturas inserti
INSERT INTO fakturas(paketKorisnikaID, cena, placeno, datumPlacanja)
